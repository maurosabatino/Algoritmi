...
/**
 * Classe implementazione dell'union-find di elementi interi in un
 * range[0...n-1] la struttura dati viene implementata attraverso un array di
 * interi, il quale viene inizializzato con il valore della posizione, ovvero
 * ogni nodo, ha come padre se stesso. Nel momento in cui viene creato un
 * insieme, viene inserito il riferimento al padre, scrivendone al suo interno
 * l'indice del padre.
 * 
...
public class UnionFindInt implements UnionFind {
	...
	/**
	 * costruttore il quale inizializza a lunghezza n-1 l'array parentOrNSize e il
	 * contatore count al numero di inisemi presenti all'interno della struttura
	 * 
	 * @param n
	 ...
	 * di dimesione n, che deve essere obbligatoriamente maggiore della dimensione
	 * precedente, nel quale viene copiato il contenuto dell'array originale.
	 * 
